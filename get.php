...
<head>
    <title>Weather Report of <?php echo $_GET['q']; ?> - HackerRahul.com</title>
...
?>
    ...
    <div class="w3-display-container w3-wide">
        <img src="http://www.designbolts.com/wp-content/uploads/2014/03/Blue-Blur-Background1.jpg"
            style="width:100%;height:100%;" class="w3-image">
